        ...
        <div class="cv">
           <div class="container"> 
            ...
            <div v-if="employees" class="modalBody">
                ...
                <!-- user Photo -->
                <div class="userPhoto d-none">
                    <img src="../assets/image/internationalfocuslogo.jpg" alt="userPhoto" width="130px" height="130px">
                </div>
                <!-- CV Details -->
                <h5 class="text-primary pt-3">Submitted CV Details</h5>
                <div class="cvdetailsContainer">
...
.cvdetailsContainer, .otherInformation{
    padding: 5px 15px;
    border-radius: 15px;
    background-color: #FDFDFB;
    box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;
