                ...
                <div class="mb-4 ">
                    <div class="col-12 question_box_control mb-5">
                        ...
                        <div class="col-12 btn-group answer_box d-flex" role="group" aria-label="Basic radio toggle button group">
                            ...
                            <div class="col-6 form-check form-check-inline">
                                <div class="col-3">
                                    <input class="form-check-input mt-2 radio_check_box" type="radio" name="inlineRadioOptions2" id="inlineRadio1" value="option3" v-model="surveyFormData.q72" />
                                    <label class="form-check-label radio_label" for="inlineRadio1">မှန်</label>
                                </div>
                                <div class="col-3"></div>
                            </div>
                            ...
                            <div class="col-6 form-check form-check-inline">
                               <div class="col-3">
                                <input class="form-check-input mt-2 radio_check_box" type="radio" name="inlineRadioOptions2" id="inlineRadio2" value="option4" v-model="surveyFormData.q72" />
                                <label class="form-check-label radio_label" for="inlineRadio2">မှား</label>
                               </div>
                               <div class="col-3"></div>
                            </div>
